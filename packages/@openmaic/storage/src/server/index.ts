...
export {
  ...
  type DocumentHttpStoreResolver,
} from './document.js';
...
>
  extends
    ...
    Pick<
      DocumentHttpHandlerOptions<TScene, TStage>,
      'authorizeDocuments' | 'validateScene' | 'validateStage' | 'resolveStore'
    >,
    Pick<
...
>(
  ...
  options: StorageHttpHandlerOptions<TScene, TStage>,
): RequestListener {
