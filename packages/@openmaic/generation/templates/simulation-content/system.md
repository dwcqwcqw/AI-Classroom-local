...
- Keep primary Start/Pause and Reset controls visible at every mobile width. Put
  them immediately after the variable controls and before the canvas in stacked
  layouts. Never hide the buttons or any ancestor that contains them.
