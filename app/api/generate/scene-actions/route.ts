...
// The configured reasoning model can legitimately take 1–2 minutes to build
// narration for a complex page. Keep this aligned with scene-content so Vercel
// does not kill an otherwise healthy generation at the old 60-second limit.
